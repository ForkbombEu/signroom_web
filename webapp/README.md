...
```
pip install / yard add signroom_web
```
...
To start using signroom_web run the following command in the root folder
...
**[🚩 Issues](../../issues)** - Bugs end errors you encounter using signroom_web.

**[💬 Discussions](../../discussions)** - Get help, ask questions, request features, and discuss signroom_web.
...
**[📖 Example](https://github.com/signroom_web/example)** - An example repository that uses signroom_web.
...
## 💼 License
    ...
    signroom_web - Electronic signature service based on Zenroom
